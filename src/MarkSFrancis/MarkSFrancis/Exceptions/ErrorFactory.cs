...
namespace MarkSFrancis
{
    ...
    /// </code>
    /// 
    /// To add more errors to the error factory, and improve it within your own applications with new standardised error messages, create a partial class with the same namespace and class name as <see cref="ErrorFactory"/>.
    /// It is recommended that you return an exception wrapped by <see cref="IThrowHelper"/>, but this is not required
    /// <code>
    /// namespace MarkSFrancis
    /// {
    ///     public static partial class ErrorFactory
    ///     {
    ///         public static IThrowHelper MyCustomError()
    ///         {
    ...
    public static partial class ErrorFactory
    {
        ...
        /// <returns></returns>
        public static IThrowHelper InvalidCast(string paramName, Type castingFrom, Type castingTo)
        {
        ...
        /// <returns></returns>
        public static IThrowHelper InvalidCast(string paramName, string castingFrom, string castingTo)
        {
        ...
        public static IThrowHelper ArgumentNull(string paramName)
        {
        ...
        public static IThrowHelper ArgumentNull(string paramName, string message)
        {
            return new CustomThrowHelper<ArgumentNullException>(
        ...
        /// </summary>
        /// <param name="paramName">The name of the parameter that caused the exception</param>
        public static IThrowHelper ArgumentOutOfRange(string paramName)
        {
        ...
        public static IThrowHelper ArgumentOutOfRange(string paramName, string message)
        {
            return new CustomThrowHelper<ArgumentOutOfRangeException>(
        ...
        /// <param name="message">The message that describes the error</param>
        public static IThrowHelper ArgumentOutOfRange(string paramName, object actualValue, string message)
        {
            return new CustomThrowHelper<ArgumentOutOfRangeException>(
        ...
        /// </summary>
        /// <param name="paramName">The name of the parameter that caused the exception</param>
        public static IThrowHelper ArgumentLessThanZero(string paramName)
        {
        ...
        /// <param name="paramName">The name of the parameter that caused the exception</param>
        /// <param name="actualValue">The value of the argument that caused this exception</param>
        public static IThrowHelper ArgumentLessThanZero(string paramName, object actualValue)
        {
        ...
        /// </summary>
        /// <param name="message">A message that describes the error</param>
        public static IThrowHelper ArgumentException(string message)
        {
        ...
        public static IThrowHelper ArgumentException(string message, string paramName)
        {
        ...
        public static IThrowHelper IndexOutOfRange(string indexerName)
        {
        ...
        public static IThrowHelper IndexOutOfRange(string indexerName, int indexerValue)
        {
        ...
        public static IThrowHelper IndexOutOfRange(string indexerName, int indexerValue, int collectionValuesCount)
        {
        ...
        public static IThrowHelper IndexOutOfRange(string indexerName, int indexerValue, string collectionName)
        {
        ...
        /// <param name="collectionName">The name of the collection of values that was being accessed by the indexer</param>
        /// <param name="collectionValuesCount">The number of values in the collection that was being accessed by the indexer</param>
        public static IThrowHelper IndexOutOfRange(string indexerName, int indexerValue, string collectionName, int collectionValuesCount)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static IThrowHelper NotImplemented()
        {
        ...
        /// <returns></returns>
        public static IThrowHelper NotImplemented(string todoNote)
        {
