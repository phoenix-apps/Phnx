...
{
    /// <summary>
    /// Makes it easier to throw custom errors with custom messages, and inner exceptions from the <see cref="Errors"/>
    /// </summary>
    /// <typeparam name="T">The type of exception to throw</typeparam>
    public class ThrowHelper<T> : ThrowHelper where T : Exception
    {
