namespace Phnx.AspNet.Context.Interfaces
{
    /// <summary>
    /// A service for managing the current <see cref="System.Web.HttpContext"/> session
    /// </summary>
    public interface ISessionService
    {
        /// <summary>
        /// Get a session value by key from the current <see cref="System.Web.HttpContext"/>
        /// </summary>
        ...
        /// <summary>
        /// Set a session value by key to the current <see cref="System.Web.HttpContext"/>
        /// </summary>
