...
namespace Phnx.IO.Threaded.Tests
{
    public class ThreadedReaderTests
    {
        ...
        //        int index = 0;
        //        using (var reader = new ThreadedReader<string>(() => expected[index++], 0))
        //        {
        //            results.Add(reader.Read());
        //            results.Add(reader.Read());
        //            results.Add(reader.Read());
